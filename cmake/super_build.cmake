...
function(SET_SUPERBUILD TARGET_NAME CMAKE_CONFIG_PATH)
    ...
    set(TARGET_BINARY_DIR  "${SUPERBUILD_ROOT_PATH}/dep/${CMAKE_BUILD_TYPE}/${TARGET_NAME}")
    set(TARGET_INSTALL_DIR "${SUPERBUILD_INSTALL_DIR}/${CMAKE_BUILD_TYPE}")
